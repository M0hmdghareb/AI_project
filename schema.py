...
initial_state = {
  ...
  'feature': {
    ...
    'imgUrl': search_image(f"     {user_text}")
  },
  'testimonials': {
  ...
  'companies': [
    {'imgUrl': search_image(f"logo 1 for comany which related to {user_text}  ")},
    {'imgUrl': search_image(f"logo 2 for comany which related to {user_text}  ")},
    {'imgUrl': search_image(f"logo 3 for comany which related to {user_text}  ")},
    {'imgUrl': search_image(f"logo 4 for comany which related to {user_text}  ")},
    {'imgUrl': search_image(f"logo 5 for comany which related to {user_text}  ")}
    ]   
  },
  'projects':{
